...
<div class="card-glass px-5 sm:px-6 py-4 sm:py-5">
    <div class="text-center space-y-3">
        <p class="text-xs font-semibold uppercase tracking-[0.12em] text-white/40">{{ $tournament->name }}</p>

        <div class="flex flex-wrap items-center justify-center gap-2 text-sm text-white/50">
