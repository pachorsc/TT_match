            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="border-b border-white/[0.06]">
                        ...
                        <th class="text-center px-5 sm:px-6 py-3 text-xs font-semibold uppercase tracking-[0.1em] text-white/30">Ranking</th>
                        <th class="text-right px-5 sm:px-6 py-3 text-xs font-semibold uppercase tracking-[0.1em] text-white/30">Points</th>
                        <th class="text-center px-5 sm:px-6 py-3 text-xs font-semibold uppercase tracking-[0.1em] text-white/30">Movement</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-white/[0.04]">
                    @foreach($rankings as $i => $ranking)
                        ...
                        <tr class="hover:bg-white/[0.02] transition-colors">
                            ...
                            <td class="px-5 sm:px-6 py-3 text-center font-bold text-white/90">
                                #{{ $ranking->ranking }}
                            </td>
                            <td class="px-5 sm:px-6 py-3 text-right font-mono text-white/70">
