            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="border-b border-gray-200/80 dark:border-white/[0.06]">
                        ...
                        <th class="text-center px-5 sm:px-6 py-3 text-xs font-semibold uppercase tracking-[0.1em] text-gray-500 dark:text-white/30">Ranking</th>
                        <th class="text-right px-5 sm:px-6 py-3 text-xs font-semibold uppercase tracking-[0.1em] text-gray-500 dark:text-white/30">Points</th>
                        <th class="text-center px-5 sm:px-6 py-3 text-xs font-semibold uppercase tracking-[0.1em] text-gray-500 dark:text-white/30">Movement</th>
                    </tr>
                </thead>
