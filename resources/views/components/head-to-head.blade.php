...
<div class="card-glass overflow-hidden">
    ...
    @else
        <div class="px-5 sm:px-6 py-6 sm:py-8">
            <div class="flex items-center justify-center gap-6 sm:gap-12 mb-6">
                ...
                <div class="text-center shrink-0">
                    <p class="text-xl font-bold text-gray-400 dark:text-white/30">{{ $headToHead['total_matches'] }}</p>
                    <p class="text-[10px] text-gray-300 dark:text-white/20 uppercase tracking-widest">Matches</p>
                </div>
            ...
            @if($headToHead['total_matches'] > 0)
                ...
                @endphp
                <div class="flex items-center gap-0 h-2 rounded-full overflow-hidden bg-black/[0.04] dark:bg-white/[0.04] max-w-sm mx-auto">
        ...
        @if($headToHead['matches']->isNotEmpty())
            <div class="overflow-x-auto border-t border-black/[0.06] dark:border-white/[0.06]">
                <table class="w-full text-sm">
                    <thead>
                        <tr class="border-b border-black/[0.06] dark:border-white/[0.06]">
                            ...
                            <th class="text-center px-5 sm:px-6 py-3 text-xs font-semibold uppercase tracking-[0.1em] text-gray-400 dark:text-white/30">Winner</th>
                        </tr>
                    </thead>
