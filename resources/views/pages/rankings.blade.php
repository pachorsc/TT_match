<x-layout title="Rankings">
    ...
    <div class="space-y-10 sm:space-y-12">
        ...
        <div class="text-center space-y-2">
            <h1 class="text-3xl sm:text-4xl font-extrabold tracking-tight text-gray-900 dark:text-white">Rankings Mundiales</h1>
            <p class="text-sm sm:text-base text-gray-500 dark:text-white/40">Clasificación actualizada de los mejores jugadores</p>
        </div>
