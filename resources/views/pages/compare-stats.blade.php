        ...
        <div class="card-glass p-4 sm:p-5">
            ...
            <form method="GET" action="{{ route('compare.stats') }}" class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    {{-- Player A --}}
                    <div>
                        <label class="block text-[10px] font-semibold uppercase tracking-[0.1em] text-gray-400 dark:text-white/30 mb-1.5">Jugador A</label>
                    ...
                    {{-- Player B --}}
                    <div>
                        <label class="block text-[10px] font-semibold uppercase tracking-[0.1em] text-gray-400 dark:text-white/30 mb-1.5">Jugador B</label>
                        <div class="player-search relative">
            ...
            <div class="space-y-6 sm:space-y-8">
                ...
                <div class="relative flex items-center justify-center gap-4 sm:gap-8 py-6 animate-fade-in">
                    ...
                    <div class="flex-1 text-right min-w-0">
                        <a href="{{ route('players.show', $playerA) }}" class="text-lg sm:text-2xl font-black tracking-tight text-gray-900 dark:text-white/90 hover:text-sport-400 transition-colors block truncate">
                            {{ $playerA->full_name }}
                        </a>
                    ...
                    <div class="flex-1 text-left min-w-0">
                        <a href="{{ route('players.show', $playerB) }}" class="text-lg sm:text-2xl font-black tracking-tight text-gray-900 dark:text-white/90 hover:text-sport-400 transition-colors block truncate">
                            {{ $playerB->full_name }}
                        </a>
                        ...
                        @foreach([$stats['recentForm']['playerA'], $stats['recentForm']['playerB']] as $i => $form)
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center justify-between">
                                    <a href="{{ route('players.show', $p) }}" class="text-sm font-semibold text-gray-600 dark:text-white/70 hover:text-sport-400 transition-colors">{{ $p->full_name }}</a>
                ...
                <div class="text-center pt-2">
                    <a href="{{ route('compare', ['gender' => $gender, 'player_a' => $playerA->id, 'player_b' => $playerB->id]) }}"
                       class="inline-flex items-center gap-2 text-sm text-gray-400 dark:text-white/30 hover:text-sport-400 transition-colors">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
